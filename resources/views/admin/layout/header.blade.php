    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header mb-2">
            ...
            <a class="navbar-brand m-0" href="  " target="_blank">
                <div style="background:#ffff;border-radius:15px;padding:20px;">
                    <img src="{{ asset('stallmaillogo.png') }}" class="navbar-brand-img " alt="main_logo"
                        style="width=120%;">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('stalls*') ? 'active' : '' }}" href="{{ route('stalls.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Stalls</span>
                    </a>
                </li>
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            {{--  <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank"
                                ...
                                Builder</a>  --}}
                            <h4 class="mt-2" style="padding:10px 20px;color:#393185;">Welcome
                                {{ Auth::user()->name }}</h4>
                        </li>
                        <li class="nav-item d-flex align-items-center">
